...
/**
 * @FileName com.atguigu.controller.HouseImageController
 * @Create 2023/6/6:08:41
 * @Author WCH
 * Description:
 */
@Controller
...
public class HouseImageController {
    @Reference
    public HouseImageService houseImageService;
    @Reference
    ...
    /**
     * 从前端show页面发来的请求携带了houseId和照片类型type(房源照片还是房产照片)
     * @param houseId
     * @param type
     * @param model
     * @return
    ...
    public String delete(@PathVariable("houseId") Integer houseId,@PathVariable("id") Integer id){
        ...
        //2. 调用七牛云的工具类的方法根据图片在七牛云中的存储路径删除图片
