...
public class QiniuUtils {
    private static String accessKey = "mh4lUw7HLBv3ijjY1M-kHQR7VD3GkNFsw58j7a7m";
    private static String secretKey = "lI7FhtOJw7xfAjcguWjb8nWmilP4AoB-Sseux5YV";
    private static String bucket = "shf0301wch";
    ...
    public static String getUrl(String filePath) {
        return "http://rvnt2exgt.hn-bkt.clouddn.com/" + filePath;
    }
}
